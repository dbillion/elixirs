defmodule MysocialappWeb do
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/mysocialapp_web/templates",
        namespace: MysocialappWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MysocialappWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import MysocialappWeb.LiveHelpers
